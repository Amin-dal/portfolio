  ...
  const projects = [
    {
      ...
      description:
        "Modern POS and inventory management solution for retail businesses, featuring inventory tracking, payment processing, automated purchase orders, and business reporting.",
    ...
    },
    {
      ...
      description:
        "Fashion and lifestyle eCommerce website showcasing trendy clothing collections, seamless product browsing, and a user-friendly shopping experience across all devices.",
      tags: [
        "WordPress",
        "WooCommerce",
        "Elementor",
    ...
    },
    {
      ...
      url: "https://vosgi.in",
      description:
        "legant jewelry showcase website featuring premium collections, modern design, and a seamless browsing experience across all devices.",
      tags: [
        "WordPress",
        "WooCommerce",
        "Custom Theme",
    ...
    },
    {
      ...
      description:
        "Corporate website for a leading engineering company featuring comprehensive service listings and project portfolios.",
      tags: [
        "WordPress",
        "Elementor",
        "Custom CSS",
    ...
    },
    {
      ...
      description:
        "Modern business website and product catalog built with scalable e-commerce capabilities.",
      tags: [
        "WordPress",
        "WooCommerce",
        "Elementor",
    ...
    {
      title: "Stop 24food Store",
      url: "https://stop24food.com",
      description:
        "Online food store offering fresh groceries, daily essentials, and convenient shopping experience.",
      tags: [
        "WordPress",
        "Custom CSS",
        "Elementor",
      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex flex-col items-center justify-center text-center mb-16">
          ...
          <p className="text-muted-foreground max-w-2xl text-lg">
            A selection of recent projects showcasing my expertise in building
            high-quality, scalable WordPress solutions.
          </p>
        </div>
          ...
          {projects.map((project, index) => (
            <motion.div
              ...
              <div className="p-6 relative z-20 bg-background">
                ...
                <p className="text-muted-foreground text-sm mb-6 h-16">
                  {project.description}
                </p>
        ...
        <div className="mt-8 text-center">
          <span className="inline-flex items-center px-6 py-3 rounded-full border">
            Want to See More Work? Let's Connect
          </span>
        </div>
      </div>
    </section>
